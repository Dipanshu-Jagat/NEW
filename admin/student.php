...
<!-------------------SIDEBAR0------------------>
		...
		<div id = "sidecontent" class = "well pull-right" style="margin-right:58px; margin-top:92.5px;" >
				<div class = "alert alert-info">Accounts/User</div>
				<button type = "button" id = "add_student" class = "btn btn-success"><span class = "glyphicon glyphicon-plus"></span> Add User</button>
