...
<div style = "padding:20px; margin-left:50px;" class = "col-md-8 alert-success">	
	<table class = "table">	
		<tr>
			<td><label>User ID:</label></td><td><label class = "text-danger"><?php echo $f_student['student_id']?></label></td>
		</tr>
		<tr>
			<td><label>Name:</label></td><td><label class = "text-danger"><?php echo $f_student['firstname']." ".$f_student['lastname']?></label></td>
		</tr>
		<tr>
			<td><label>Block:</label></td><td><label class = "text-danger"><?php echo $f_student['year']."-".$f_student['section']?></label></td>
		</tr>
	</table>
</div>
<br style = "clear:both;"/>
