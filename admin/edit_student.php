								...
								<div style = "width:40%; margin-left:32%;">	
									...
									<div class = "form-group">
										...
										<select class = "form-control" name = "year" required = "required">
											...
											<option <?php if($f_student['year'] == "I"){echo "selected";}?> value = "I">G-</option>
											<option <?php if($f_student['year'] == "II"){echo "selected";}?> value = "II">H-</option>
											<option <?php if($f_student['year'] == "III"){echo "selected";}?> value = "III">P-</option>
											<option <?php if($f_student['year'] == "IV"){echo "selected";}?> value = "IV">R-</option>
										</select>
									</div>
									<div class = "form-group">
										<label>Number</label>
